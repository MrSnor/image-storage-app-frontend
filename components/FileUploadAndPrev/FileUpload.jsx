...
const FileUpload = (props) => {
  ...
  const uploadFiles = async () => {
    ...
    Swal.fire({
      ...
      text: `Successfully uploaded ${totalFiles} file${totalFiles > 1 ? 's' : ''}!`,
  ...
  return (
    <div className="group overflow-y-hidden my-4">
      ...
      <button
        type="button"
        className={`my-4 ml-auto block rounded border border-red-500 p-1 text-rose-500 transition-colors hover:bg-rose-500 hover:text-white disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-transparent`}
        onClick={() => setFiles([])}
